...
export default function DefaultModule() {
  ...
  //   const [close, setOpen] = useState(flase);
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                ...
                <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row sm:px-6">
                  <button
                    type="button"
                    className="inline-flex w-full justify-center rounded-md bg-purple-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:me-3 sm:w-auto"
                    onClick={() => setOpen(false)}
                  >
                    Add Task
                  </button>
